            ...
            <div class="product-card" onclick="location.href='<?= e(appUrl('/public/product.php?id=' . $relProduct['id'])) ?>'">
                ...
                <div class="product-info">
                    ...
                    <?php if ($relPrice !== null): ?>
                        <?php if ($isBusiness): ?>
                            <p class="product-price"><?= e(formatMoney($relPrice)) ?> <small class="product-price-small-label">netto</small></p>
                        <?php else: ?>
                            <p class="product-price"><?= e(formatMoney(grossFromNet($relPrice))) ?> <small class="product-price-small-label">brutto</small></p>
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="product-price product-price-no-price">Brak ceny</p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
