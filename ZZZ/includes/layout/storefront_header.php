...
<?php if ($msg = flash('success')): ?>
    <div class="alert-success" style="max-width:1280px;margin:80px auto 0;padding:12px 24px;border-radius:8px;"><?= e($msg) ?></div>
<?php endif; ?>
<?php if ($msg = flash('error')): ?>
    <div class="error-msg" style="max-width:1280px;margin:80px auto 0;padding:12px 24px;border-radius:8px;"><?= e($msg) ?></div>
<?php endif; ?>
